...
public class NetCDFReadTask extends AbstractTask {
    ...
    System.out.println("massValueVariable");
    System.out.println(massValueVariable);
    ...
    System.out.println("intensityValueVariable");
    System.out.println(intensityValueVariable);
    ...
    System.out.println("scanIndexArray");
    System.out.println(scanIndexArray);
	...
	while (scanIndexIterator.hasNext()) {
        ...
        System.out.println("scanStartPositions[ind]");
        System.out.println(scanStartPositions[ind]);
