...
public class ChromatogramBuilderParameters extends SimpleParameterSet {
    ...
    public static final DoubleParameter minimumScanSpan = new DoubleParameter(
            "Min peak span (in number of scans)",
    ...
    public static final DoubleParameter noise = new DoubleParameter(
            "Noise",
            "Points below this intensity value will not be added to the chromoatogram at all.",
            MZmineCore.getConfiguration().getIntensityFormat());
    ...
    public ChromatogramBuilderParameters() {
        super(new Parameter[] { dataFiles, scanSelection, massList,
                minimumScanSpan, startIntensity, noise, mzTolerance, suffix });
    }
